...
import { CLAUDIAN_STORAGE_PATH, GROKIAN_CANDIDATES_PATH } from '../../core/bootstrap/StoragePaths';
import { VaultFileAdapter } from '../../core/storage/VaultFileAdapter';
import { StorySidecarStorage } from '../../core/story/StorySidecarStorage';
...
export class SharedStorageService implements SharedAppStorage {
  ...
  readonly storySidecar: StorySidecarStorage;
  ...
  constructor(plugin: Plugin) {
    ...
    this.storySidecar = new StorySidecarStorage(this.adapter);
  }
